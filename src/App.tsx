...
function App() {
    ...
    function addTask(todolistId: string, title: string) {
        ...
        setTasks((prevState) => ({
            ...prevState,
            [todolistId]: {...prevState[todolistId], data : [...prevState[todolistId].data, newTask ]}
        }))
    ...
    function changeStatus(todolistId: string, taskId: string, newIsDone: boolean) {
        setTasks((prevState) => ({
            ...prevState,
            [todolistId]: {...prevState[todolistId], data: prevState[todolistId].data.map(el => el.id === taskId ? {...el, isDone: newIsDone} : el)}
        }))
    }
    ...
    function changeFilter(todolistId: string, value: FilterValuesType) {
        ...
        setTasks((prevState) => ({
            ...prevState,
            [todolistId] : {...prevState[todolistId], filter: value}}))
    }
